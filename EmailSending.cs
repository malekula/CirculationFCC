...
namespace Circulation
{
    public partial class EmailSending : Form
    {
        ...
        public EmailSending(Form1 f1_, ReaderVO reader_)
        {
            ...
            richTextBox1.Text += rn + "Просим Вас в ближайшее время вернуть литературу во Французский культурный центр Библиотеки иностранной литературы." + rn +
                "С уважением, " + rn +
                "Французский культурный центр ВГБИЛ," + rn +
                "тел. +7 (495) " + rn +
